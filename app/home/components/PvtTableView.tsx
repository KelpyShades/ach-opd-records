...
export default function PvtTableView() {
    const [records, setRecords] = useState<PvtRecord[]>([])
    const [filteredRecords, setFilteredRecords] = useState<PvtRecord[]>([])
    ...
    const [editingRecord, setEditingRecord] = useState<PvtRecord | null>(null)
    ...
    const debouncedName = useDebounce(searchName, 600)
    const debouncedMembershipNumber = useDebounce(searchMembershipNumber, 600)
    const debouncedPhone = useDebounce(searchPhone, 600)
    ...
    useEffect(() => {
        ...
        const channel = supabase
            .channel('records_private_changes', {
                config: {
                    broadcast: { self: true },
                },
            })
            .on(
                'postgres_changes',
                {
                    ...
                    schema: 'public',
                    table: 'records_private',
                },
                (payload) => {
                    if (payload.eventType === 'INSERT') {
                        const newRecord = payload.new as PvtRecord
                        ...
                        const updatedRecord = payload.new as PvtRecord
                        console.log(
                        ...
                        const deletedRecord = payload.old as PvtRecord
                        console.log(
        ...
        async (serverSearch = false) => {
            try {
                ...
                if (serverSearch) {
                    ...
                    if (debouncedPhone) {
                        query = query.ilike('phone', `%${debouncedPhone}%`)
                    }
                    if (filterYear !== 'all') {
    ...
    const openEditDialog = (record: PvtRecord) => {
            ...
            >
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="flex flex-col flex-wrap justify-evenly gap-4 md:flex-row">
                        ...
                        <div className="flex-1">
                            <Label
                                htmlFor="search-membership-number"
                        ...
                        <div className="flex-1">
                            <Label htmlFor="search-phone" className="mb-2 block">
                                Search Phone
                            </Label>
                            <div className="relative">
                                <Search className="absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-gray-400" />
            ...
            <Dialog open={editDialog} onOpenChange={setEditDialog}>
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div>
                            <Label htmlFor="edit-membership-number">
                                Company
                            </Label>
                            <Input
                                id="edit-company"
